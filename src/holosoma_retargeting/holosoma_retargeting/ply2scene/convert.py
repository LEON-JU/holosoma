...
class Ply2SceneConfig:
    ...
    nksr_checkpoint_path: Optional[Path] = "/home/juyiang/data/holosoma/src/holosoma_retargeting/holosoma_retargeting/ply2scene/ks.pth"
...
def _select_mesh_method(cfg: Ply2SceneConfig) -> Literal["poisson", "nksr"]:
...
def main(cfg: Ply2SceneConfig) -> None:
    ...
    if method == "poisson":
        ...
        pts = points
        if cfg.nksr_max_points is not None and int(cfg.nksr_max_points) > 0 and pts.shape[0] > int(cfg.nksr_max_points):
